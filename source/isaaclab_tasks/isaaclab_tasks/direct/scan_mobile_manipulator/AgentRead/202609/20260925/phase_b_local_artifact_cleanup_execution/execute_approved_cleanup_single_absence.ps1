...
$taskGeneratedOutputPaths=@('execution_authority_single_absence.json','execution_result_single_absence.json','deletion_log_single_absence.jsonl')|ForEach-Object {Join-Path $taskExecutionRoot $_}
...
foreach($name in @('execution_authority_single_absence.json','deletion_log_single_absence.jsonl','execution_result_single_absence.json')){
...
$taskLogStream=[IO.FileStream]::new((Join-Path $taskExecutionRoot 'deletion_log_single_absence.jsonl'),[IO.FileMode]::CreateNew,[IO.FileAccess]::Write,[IO.FileShare]::Read,4096,[IO.FileOptions]::WriteThrough)
...
Save-NewJson 'execution_authority_single_absence.json' $taskAuthority
...
if(-not(Test-Path -LiteralPath (Join-Path $taskExecutionRoot 'execution_authority_single_absence.json'))){Save-NewJson 'execution_authority_single_absence.json' $taskAuthority}
...
Save-NewJson 'execution_result_single_absence.json' $result
