...
B2-T4-RE6-R7 is **PRE-RUNTIME STOP / FORMAL ATTEMPTS 0 / NOT POISONED**.
...
- RE6-R7: **PRE-RUNTIME STOP / FORMAL ATTEMPTS 0 / NOT POISONED**
...
Independent GPT review of the R7 pre-runtime normalizer-contract STOP. A new instruction is required before any normalizer revision or later runtime attempt.
