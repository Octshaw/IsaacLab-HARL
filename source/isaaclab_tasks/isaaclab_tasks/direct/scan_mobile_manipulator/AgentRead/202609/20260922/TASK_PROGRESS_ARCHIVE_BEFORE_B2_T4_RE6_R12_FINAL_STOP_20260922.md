...
B2-T4-RE6-R12 is **EXPLICITLY AUTHORIZED / PURE STAGE-A PREFLIGHT IN PROGRESS**.
...
- RE6-R12 supervisor / worker / PID binding / release / CUDA: **0 / 0 / 0 / 0 / 0**
- RE6-R12 live authority: **0**
- R12 repair window: **PURE STAGE A ONLY**
...
R12 is introducing explicit artifact lifecycle classes and separate ownership paths for the preflight NORM-context template and the PID-bound canonical trusted context. The canonical live path must remain absent through Stage A and final pre-process, then be created exactly once after the sole worker PID and run binding exist.
...
Implement and fully rehearse the independent R12 Stage-A lifecycle ownership/collision/reservation campaign. Do not create a live R12 authority until Stage A passes and the R12 harness is frozen.
