...
B2-T4-RE6-R13 is **EXPLICITLY AUTHORIZED / PURE STAGE-A PREFLIGHT**.

B2-T4-RE6-R12 is **GPT REVIEW STOP CONFIRMED / HISTORICAL / POST-MUTATION / POISONED / RETAINED / LEARNER NEVER REUSE**.
...
- RE6-R13 authority / supervisor / worker / PID binding / release / CUDA: **0 / 0 / 0 / 0 / 0 / 0**
- RE6-R13 retries: **0**
- RE6-R13 repair window: **PURE STAGE A ONLY**
...
R13 begins with a pure, process-free projection-parity campaign. It must establish one shared builder from canonical-shaped artifacts to the LAQ source map, use the identical implementation in Stage A and actual runtime, project `witnesses.W7.qualified_count=160`, and repair the supervisor's upstream-STOP handling before freeze.
...
Do not resume or retry R12, reuse PID 29544 or its binding/learner, or modify frozen R9-R12. Do not create a live R13 authority, supervisor, worker, PID binding, release, or CUDA context before R13 Stage A passes and freezes. Do not begin R14, checkpoint work, long/paper-scale training, evaluation/playback, public-route activation, staging, commit, or push.

## Next step

Complete the R13 shared-builder Stage-A parity, full 179-path fail-closed matrix, value crosscheck, failure-path supervisor negative, lifecycle preservation, identity gate, and freeze. Only then may the single authorized R13 formal process begin.
