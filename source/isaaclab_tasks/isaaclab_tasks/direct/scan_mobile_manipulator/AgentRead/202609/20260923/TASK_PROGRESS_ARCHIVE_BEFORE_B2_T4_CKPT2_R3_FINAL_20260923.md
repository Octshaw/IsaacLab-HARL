...
- B2-T4-CKPT2-R3: **EXPLICITLY AUTHORIZED / PRE-RUNTIME IDENTITY REPAIR**
...
Current phase: **B2-T4-CKPT2-R3 pre-runtime identity authority and production-schema qualification**. No CKPT2-R3 CUDA/Isaac process has started.
...
Do not alter historical CKPT2/CKPT2-R1/CKPT2-R2 artifacts, edit any frozen historical harness, retry a historical attempt, launch CKPT2-R3 Process B unless its Process-A semantic gate passes, claim real checkpoint continuation before evidence completes, launch R15, run evaluation/playback, begin long/paper-scale training, activate a public learned-policy route, or stage/commit/push. After CKPT2-R3 Process A starts: no source edit, repair, or retry.

## Next step

Complete the authorized CKPT2-R3 pre-runtime identity authority, production-dataclass schema parity, ledger-v2 qualification, preservation checks, and source freeze. Only after all gates pass may the single authorized fresh Process A begin.
