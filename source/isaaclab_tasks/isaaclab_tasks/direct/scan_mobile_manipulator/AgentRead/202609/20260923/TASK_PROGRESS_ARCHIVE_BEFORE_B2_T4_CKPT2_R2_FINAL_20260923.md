...
- B2-T4-CKPT2-R2: **EXPLICITLY AUTHORIZED / PRE-RUNTIME HARNESS REPAIR**
...
Current CKPT2-R2 classification: **PRE-RUNTIME / NOT YET EXECUTED**
...
Create and purely qualify the new CKPT2-R2 harness, freeze it, then execute exactly one authorized fresh attempt. Stop after success or the first source-backed STOP.
