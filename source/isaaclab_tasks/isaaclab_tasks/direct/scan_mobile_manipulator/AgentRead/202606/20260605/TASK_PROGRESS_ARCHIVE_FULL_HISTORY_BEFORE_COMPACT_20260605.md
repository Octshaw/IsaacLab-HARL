...
Report created:
- `source/isaaclab_tasks/isaaclab_tasks/direct/scan_mobile_manipulator/AgentRead/202606/20260604/ASSIGNMENT_BASED_RL_PHASE2_HARL_DISCRETE_SHAPE_REPORT.md`
...
- `rg -n "^" source/isaaclab_tasks/isaaclab_tasks/direct/scan_mobile_manipulator/AgentRead/202606/20260604/RL_ASSIGNMENT_PIPELINE_DIAGNOSTIC_REPORT.md`
...
- The user requested `AgentRead/RL_ASSIGNMENT_PIPELINE_DIAGNOSTIC_REPORT.md`. In the current filesystem, that root-level
  file was not found by `rg`; the same-named report under `AgentRead/202606/20260604/` was read and used.
