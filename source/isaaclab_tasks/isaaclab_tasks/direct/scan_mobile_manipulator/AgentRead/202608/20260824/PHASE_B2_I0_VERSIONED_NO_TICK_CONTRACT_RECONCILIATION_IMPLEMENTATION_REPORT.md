...
- `AgentRead/202608/20260824/TASK_PROGRESS_ARCHIVE_BEFORE_B2_I0_HANDOFF_20260824.md` — exact pre-condense handoff archive, required by `AGENTS.md` because the previous file exceeded the concise handoff guideline.
